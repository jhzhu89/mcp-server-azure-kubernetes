...
function parseListServicesResponse(
  responseText: string,
...
function parseUpdateServiceResponse(
  responseText: string,
...
function parseDeleteServiceResponse(
  responseText: string,
...
describe("test kubernetes service", () => {
  ...
  test("describe service", async () => {
    ...
    console.log(
      "Service describe output (first 150 chars):",
      describeResponse.content[0].text.substring(0, 150) + "...",
    );
  ...
  test("update service", async () => {
    ...
    const updatedPorts = [
      { port: 90, targetPort: 9090, protocol: "TCP", name: "http-updated" },
    ];
  ...
  test("delete service", async () => {
    ...
    console.log(
      ...
      listBeforeResponse.content[0].text,
    );
    ...
    console.log(
      "Second service creation response:",
      createSecondResponse.content[0].text,
    );
    await sleep(1000);
    ...
    if (getAllJson.items && getAllJson.items.length > 0) {
      const serviceNames = getAllJson.items.map(
  ...
  test("create NodePort service", async () => {
    ...
    console.log(
      "NodePort service creation response:",
      createResponse.content[0].text,
    );
    await sleep(1000);
    ...
    console.log(
      "Services after NodePort creation:",
    ...
    console.log(
      "NodePort service describe (first 150 chars):",
      describeResponse.content[0].text.substring(0, 150) + "...",
    );
    ...
    console.log(
      "NodePort service wide format:",
      getWideResponse.content[0].text,
    );
